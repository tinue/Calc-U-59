...
description: Use this skill when working on the Swift/SwiftUI code of Calc-U-59 (App/, Views/, Bridge/). Covers EmulatorViewModel, the ObjC++ bridge, display, keyboard, debug panels, printer, card reader, settings, and state file I/O. Trigger on any task that touches App/*.swift, Views/*.swift, Bridge/, or the Xcode project.
user-invocable: true
---

# Calc-U-59 Swift GUI

This skill covers all work inside `App/`, `Views/`, and `Bridge/`.
...
EmulatorViewModel          (App/EmulatorViewModel.swift, 103 KB)
  ...
  │
  └─ Views/                (SwiftUI, thin bindings only)
