...
function useRouter() {
  ...
  var onNav = React.useCallback(function (target) {
    var path = typeof target === "string" && target.charAt(0) === "/" ? normalizePath(target) : pathForTarget(target);
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SiteHeader, {
    ...
    onNav: onNav
  }), page === "about" && /*#__PURE__*/React.createElement(AboutTi59Page, {
    onNav: onNav
  }), page === "start" && /*#__PURE__*/React.createElement(GettingStartedPage, {
    key: route.topic,
    initialTopic: route.topic,
    onNav: onNav
  }), page === "play" && /*#__PURE__*/React.createElement(PlayPage, {
    onNav: onNav
  }), page === "install-mobile" && /*#__PURE__*/React.createElement(InstallMobilePage, {
    onNav: onNav
    ...
    onNav: onNav
  }), page === "ref" && /*#__PURE__*/React.createElement(ReferencePage, {
    onNav: onNav
